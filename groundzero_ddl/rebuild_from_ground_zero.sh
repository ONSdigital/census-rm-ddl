...
PSQL_ACTIONCONNECT_WRITE_MODE="sslmode=verify-ca sslrootcert=/root/.postgresql-action/root.crt sslcert=/root/.postgresql-action/postgresql.crt sslkey=/root/.postgresql-action/postgresql.key hostaddr=$B_HOST_ACTION user=rmuser password=password dbname=$DB_NAME"
